...
\fullfig[width=0.6\textwidth]{schema_stavba}[Schéma sestavení termočlánku]
...
\opt{normal}{
    \fullfig{schema_exp}[Schéma sestavení experimentu]
}
\opt{forschool}{
...
Místnost, v~níž byl experiment měřen, měla konstantní teplotu~$"21 \C"$,
...
V tomto přepisu neznáme parametr~$\alpha$, jenž je ale vypočitatelný

...
% je to opravdu (ověřit AND vypočítat) XOR vyjádřit? (pokud OR, tak "nebo"
% bez čárky)
% mělo by to být ověřit OR vypočítat OR vyjádřit, respektive pokud se nepletu
% tak jsem to původně myslel jako ověřit XOR vypočítat XOR vyjádřit
%  vyndala jsem "a", aby to byly jasné XOR všude a nezavánělo to ANDem

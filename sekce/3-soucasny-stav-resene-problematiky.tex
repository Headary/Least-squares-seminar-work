...
přibližuje správnému výsledku. Jsou využívány pro řešení nelineárních problému,
které nejsem schopni analyticky řešení. Tato metoda je umožněna využitím
optimalizovaných počítačových algoritmů, například pomocí
...
\eq[m]{
    a\nsumx+nb = \nsumy\quad&\Rightarrow\quad b=\frac{\nsumy-a\nsumx}{n}\\
